...
/*
  * QUESTION
  * We basically have a perm, and we've to tell the number of 1-exquisite, 2-exquisite, etc...
  * k-exquisite = number of sub arrays, that don't have l == r, and the min diff btw any 2 adj elements is >= k
  * 
  * now, im thknking of making an array of differences between adj elements, and also...note that if l!=r, and we need 2 elements
  * num = n*(n-1)/2...
*/
void solve() {
