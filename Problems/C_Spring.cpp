...
void solve() {
  ...
  int c1 = m/a, c2 = m/b, c3 = m/c;
  int cc1 = a*b/__gcd(a,b);
  int cc2 = b*c/__gcd(b,c);
  int cc3 = a*c/__gcd(a,c);

  cc1 = m/cc1;
  cc2 = m/cc2;
  cc3 = m/cc3;

  // int ccc = a*b*c/(__gcd(a,__gcd(b,c)));
  int ccc = m/((a*b/__gcd(a,b))*c/__gcd(a*b/__gcd(a,b),c));

  int a1 = ccc*2, a2 = ccc*2, a3 = ccc*2;
  ...
  // debug(ccc, cc1, cc2, cc3, c1, c2,c3);
