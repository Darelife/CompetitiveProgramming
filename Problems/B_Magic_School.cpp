...
void solve() {
  ...
  if (cnt.size() == 1) {
    if (a[0] == 0) cout << n << endl;
    else if (a[0] == n - 1) cout << 0 << endl;
    else cout << -1 << endl;
  } else if (cnt.size() == 2) {
    int v1 = -1, v2 = -1;
    int c1 = 0, c2 = 0;
    ...
    if (v2 == v1 + 1) {
      if (c1 == v2 && c2 == n - v2) cout << n - v2 << endl;
      else cout << -1 << endl;
    } else {
      cout << -1 << endl;
    }
...
*/
// number of winners (the value the failures see) should be the number of ppl who see less and number of losers (n - the value the failures see) should be the number of people who see more