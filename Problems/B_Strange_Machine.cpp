...
void solve() {
    int n, q;
    cin >> n >> q;
    // soo....kodlek lets justg ek baar ke like, 
    // get what will happen to each number after 1 cycle....
    // nvm, each cycle is only of 20...we can do it quickly
    // each q is literally just 10^4....can't we just???
    // string s;
    // cin >> s;
    // vector<int> a(n);
    // for (int i = 0; i<n; i++) {
