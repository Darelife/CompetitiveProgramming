...
void solve() {
    ...
    //     cnt2[i] = cnt2[i+1]+(b[i]==1);
    // } 
    // lets do somethings......ek hoga ki we just ignore everything and just use the present state
    // ek count banaake, ki how many times can we swap now....wait fuck....it's just whoever has the last swap....
    // nvm, that's when the diff is <=2....yeah done....nvm...it's xor...bas parity matters....but in all cases, the person with the last swap matters
