...
void solve() {
  ...
  if ((int)sqrt(l1 * b1 + l2 * b2 + l3 * b3) * (int)sqrt(l1 * b1 + l2 * b2 + l3 * b3) != l1 * b1 + l2 * b2 + l3 * b3) {
    cout << "NO" << endl;
    return;
  }
  ...
  if (l1 == s) {
    if (b2 == s - b1 && b3 == s - b1 && l2 + l3 == s) {
      cout << "YES" << endl;
      return;
    }
  }
  if (b1 == s) {
    if (l2 == s - l1 && l3 == s - l1 && b2 + b3 == s) {
      cout << "YES" << endl;
      return;
    }
  }
  ...
  if (l2 == s) {
    if (b1 == s - b2 && b3 == s - b2 && l1 + l3 == s) {
      cout << "YES" << endl;
      return;
    }
  }
  if (b2 == s) {
    if (l1 == s - l2 && l3 == s - l2 && b1 + b3 == s) {
      cout << "YES" << endl;
      return;
    }
  }
  ...
  if (l3 == s) {
    if (b1 == s - b3 && b2 == s - b3 && l1 + l2 == s) {
      cout << "YES" << endl;
      return;
    }
  }
  if (b3 == s) {
    if (l1 == s - l3 && l2 == s - l3 && b1 + b2 == s) {
      cout << "YES" << endl;
      return;
    }
  }
