...
void solve() {
  // // n numbers + even sub arrays (2^(n-1)) + odd sub arrays (need to check)
  ...
  // // for odd,
  // // for each number, if it's equal to its right adjacent element, 
  // // ans += min((index+1-0)/2, (n-index)/2)
  ...
  // I AM A FUCKING IDIOT!!!....didn't read the entire question (missed the sorting part)


  // SUBMITTING....just to save my code
}
