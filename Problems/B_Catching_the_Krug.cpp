...
void solve() {
  ...
  int ans = 0;
  // int ans1, ans2 = 0;
  // if (r1 > r2) ans1 = max(0ll, n - r2);
  // else if (r1 < r2) ans1 = max(0ll, r2);
  // if (c1 > c2) ans2 = max(0ll, n - c2);
  // else if (c1 < c2) ans2 = max(0ll, c2);
  // cout << max(ans1, ans2) << endl;

  if (r1 > r2) ans = max(ans, n - r2);
  else if (r1 < r2) ans = max(ans, r2);
  if (c1 > c2) ans = max(ans, n - c2);
  else if (c1 < c2) ans = max(ans, c2);
  cout << ans << endl;
