...
div.logo-plus-button {
  ...
  (function fixDayElementsFill() {
    // Function to change fill color of elements with class 'day'
    ...
    // Assuming applyFuncWhenElmLoaded is a function that waits for elements to be available
    // and then applies a given function to them. If it's not suitable for this use case,
    // you might need to use a MutationObserver or set an interval as done in fixAceEditor.
