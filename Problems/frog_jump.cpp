...
/*
QUESTION
We have a frog. We're at position 1. We can take either 1 step, or 2 steps.
We have to reach position N. How many such ways are possible??

INTUTION
Lets start with the brute force solution.
Basically lets give every position 2 options literally

like,

(while teaching don't directly jump to this...they will get confused when they see the base case where we return 1)
Make them literally write all the jumps for each n


for n = 5
[1,2,3,4,5], [1,3,4,5], [1,3,5], [1,2,4,5], [1,2,3,5]
...
now u can improve the time complexity, by saving the ans, or by using tabulation...this is currently O(2^n)
after the optimisation, it will be O(n)
*/
void solve() {
