...
/*
 * QUESTION
 *  A tree with n nodes. We need to label all the edges. Each int must be >0, the product must be == k, and the number of 1s among the n-1 ints must be min.
 *  f(u,v) = the sum of the numbers on the simple parth from u to v. Sum of all f(u,v)'s = the distribution index of the tree. We need the max possible di.
 *  %1e9+7
 *
 *  
 * */
