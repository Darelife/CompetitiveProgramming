  ...
  for (int i = 1; i < grid.size() - 1; i++) {
    for (int j = 1; j < grid[0].size() - 1; j++) {
      if (grid[i][j] == 'A' && grid[i - 1][j - 1] == 'M' && grid[i + 1][j - 1] == 'M' && grid[i + 1][j + 1] == 'S' && grid[i - 1][j + 1] == 'S') {
        ans++;
      } else if (grid[i][j] == 'A' && grid[i - 1][j - 1] == 'S' && grid[i + 1][j - 1] == 'S' && grid[i + 1][j + 1] == 'M' && grid[i - 1][j + 1] == 'M') {
        ans++;
      } else if (grid[i][j] == 'A' && grid[i - 1][j - 1] == 'M' && grid[i + 1][j - 1] == 'S' && grid[i + 1][j + 1] == 'S' && grid[i - 1][j + 1] == 'M') {
        ans++;
      } else if (grid[i][j] == 'A' && grid[i - 1][j - 1] == 'S' && grid[i + 1][j - 1] == 'M' && grid[i + 1][j + 1] == 'M' && grid[i - 1][j + 1] == 'S') {
        ans++;
      }
    }
  }
